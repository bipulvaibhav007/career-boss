            ...
            <div class="col-md-5">
                    <div class="get-in-tuch bg-white">
                        <form action="<?=current_url()?>" method="post" class="" id="enquiry_form">
                            ...
                            <h4 class="text-blue mb-3">Image Editing Bootcamp</h4>
                        ...
                        <div class="courser-cnt d-md-block d-none">
                            <h3 class="text-white">IMAGE EDITING BOOTCAMP</h3>
                            <p class="text-white mb-3">Course : Image editing Bootcamp <br>
                                Duration : 4 Weeks <br>
                ...
                <div class="col-md-7 px-0">
                    <figure class="pratibhakhoj">
                        <img src="<?=base_url('public/assets/images/Image-editing-bootcamp.jpg')?>" alt="">
                    </figure>
