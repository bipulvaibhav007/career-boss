                        ...
                        <ul class="m-0 p-0">
                            <?php if(!empty($courses)){
                                foreach($courses as $list){
                                    echo '<li><a href="'.base_url('course-detail/'.$list->url).'">- '.$list->course_full_name.'</a></li>';
                                }
                            } ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="footer-link user-link">
                                ...
                                <ul class="m-0 p-0">
                                    ...
                                    <li><a href="<?=base_url()?>">- Referer</a></li>
    ...
    <div style="display:none;">
        <form action="<?=base_url('enquiry'); ?>" method="post" name="hiddenform1" id="common_enquiry_form">
            <?=csrf_field();?>
    ...
    <script>
        ...
        $('.subscribeBtn').click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('home/save_subscriber') ?>",
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
