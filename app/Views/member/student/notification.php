      ...
      <div class="main-boxx">
        <div class="p-1 my-container">
          ...
          <div class="earn-boxxx">
            <h3 class="side-head pt-4">Notifications</h3>
                ...
                <div class="col-md-12 pt-4">
                    <div class="card">
                        <div class="card-header">
                          ...
                          <span>You have <?=$totNew?> notification today</span>
                        </div>
                        <div class="card-body">
                          <?php 
                          if(!empty($notify_list)){
                            echo '<div class="row">';
                            foreach($notify_list as $list){ 
                              $datetime1 = date_create(date('Y-m-d h:i:s', strtotime($list->added_at)));
                              ...
                              // echo $interval->format('%R%y years %m months'); exit;
                              // $date1 = strtotime(date('Y-m-d h:i:s', strtotime($list->added_at)));
                              // $date2 = time();
                              // $ms = $date2 - $date1;
                              // $days = round($ms / (60*60*24));

                            ?>
                              <div class="col-md-6 my-2">
                                <div class="card py-2 px-2">
                                  <p><strong><?=$list->notification_title?></strong></p>
                                  <p><?=$list->notification_description?></p>
                                  <p><?=$days.' ago'?></p>
                                </div>
                              </div>
