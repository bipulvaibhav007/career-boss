...
<html lang="en">
    ...
    <body>
        ...
        <div style="margin-top: 40px;margin-left: 40px;font-family: 'Khand', sans-serif;letter-spacing: 0.8px;font-size: 16px;">&nbsp;</div>
            <div style="display: inline-block;margin-top: 170px;margin-left: 210px;font-family: 'Khand', sans-serif;letter-spacing: 0.8px;font-size: 16px;"><?=$courseDtls->cert_no?></div>
            ...
            <div style="margin-top: 59px;margin-left: 465px;font-family: 'Poly', sans-serif;font-weight: bold;letter-spacing: 0.8px;font-size: 14px;color: #081D39;"><?=ucwords($courseDtls->stu_name)?></div>

            <div style="margin-top: 18px;margin-left: 273px;font-family: 'Poly', sans-serif;font-weight: bold;letter-spacing: 0.8px;font-size: 14px;color: #081D39;"><?=ucwords($courseDtls->f_name)?></div>
            ...
            <div style="margin-top: -18px;margin-left: 828px;font-family: 'Poly', sans-serif;font-weight: bold;letter-spacing: 0.8px;font-size: 14px;color: #081D39;"><?=$courseDtls->grade?></div>
            <?php /* <div style="margin-top: 18px;margin-left: 310px;font-family: 'Poly', sans-serif;font-weight: bold;letter-spacing: 0.8px;font-size: 14px;color: #081D39;"><?=$courseDtls->center_name?></div> */ ?>
