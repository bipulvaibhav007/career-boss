...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-1">
    <h1 class="h3 mb-0 text-gray-800">Franchise View</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="<?=base_url('admin'); ?>">Admin</a></li>
      <li class="breadcrumb-item" aria-current="page">franchise_view</li>
    ...
    <div class="col-lg-12">
      ...
      <div class="card mb-2">
        <div class="card-header py-3 bg-dark text-light d-flex justify-content-between">
          <h6 class="m-0 font-weight-bold">Regular Student's List</h6>
          <?php /* <div class="">
            <a href="<?=base_url('admin/add_edit_franchise_student/'.$franchiseDtls->m_id)?>" class="btn btn-primary btn-sm">Add Student</a>
        ...
        <div class="card-body">
          <table class="table table-bordered table-striped table-responsive">
            ...
            <tbody>
              <?php if(!empty($RegStuData)){ 
                $page = (isset($_GET['rs-page']))?$_GET['rs-page']:1;
                if($page == 1){
                    $sn=1;
                }else{
                    $sn = $limit * ($page-1) + 1;
                }  
                foreach($RegStuData as $list){ 
                ...
                ?>
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="<?=base_url('admin/view_stuuniversityinfo/'.$franchiseDtls->m_id.'/'.$list->frst_id)?>" class="btn btn-outline-info btn-sm " ><i class="fas fa-eye"></i></a>
                        <?php }else{ ?>
                        ...
                        <?php if($list->status < 1 || $list->status == 4 || $list->status == 7){ ?>
                        ...
                        <?php if($list->course_cat == 'U'){ ?>
                          <a href="<?=base_url('admin/add_edit_universityinfo/'.$franchiseDtls->m_id.'/'.$list->frst_id)?>" class="btn btn-info btn-sm" >Update University</a>
                          <a href="javascript:void(0);" class="btn btn-primary btn-sm uni_stu_change_status" data-frst_id="<?=$list->frst_id?>" data-status="<?=$list->status?>" >Change Status</a>
                        <?php }else{ ?>
                        <a href="javascript:void(0);" class="btn btn-primary btn-sm reg_stu_change_status" data-frst_id="<?=$list->frst_id?>" data-status="<?=$list->status?>" >Change Status</a>
                        <?php } ?>
              ...
              <?php }
                ...
                echo '<tr class="text-center"><td colspan="11" class="text-danger ">No List</td></tr>';
              } ?>
            </tbody>
            <?=($rs_pagination != '')?$rs_pagination:''?>
          </table>
        </div>
      </div><!-- end 3rd card -->
                ...
                ?>
                  <tr>
                    ...
                    <td>
                        <?php if($list->course_cat == 'U'){ ?>
                        <a href="<?=base_url('admin/view_stuuniversityinfo/'.$franchiseDtls->m_id.'/'.$list->frst_id)?>" class="btn btn-outline-info btn-sm " ><i class="fas fa-eye"></i></a>
                        <a href="javascript:void(0);" class="btn btn-outline-info btn-sm " onclick="view_uni_certificate('<?=$list->cert_no?>')">View Cert</a>
                        <?php }else{ ?>
                        <a href="javascript:void(0);" class="btn btn-outline-info btn-sm " onclick="view_franchise_student(<?=$list->frst_id?>)"><i class="fas fa-eye"></i></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row" >
              ...
              <div class="col-md-10 ">
                <input type="text" name="reg_fee" id="reg_fee2" value="<?=$franchiseDtls->reg_fee?>" class="form-control">
  ...
  <script>
    ...
    function view_uni_certificate(cert_no){
    ...
    function view_certificate(cert_no){
      var certUrl = "<?=base_url('public/assets/pdf')?>"+"/"+cert_no+".pdf";
      $("#certView").attr("src", certUrl + "?" + new Date().getTime());
      $("#certificateViewModal").modal("show");
    }
