...
<?=$this->section("content") ?>
  ...
  <div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
      ...
      <a href="<?=base_url('/admin/add_edit_question'); ?>" class="btn btn-success">Add Question</a>
      <?php } ?>
    </div>
          ...
          <div class="table-responsive">
            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
              <thead class="thead-light">
                <tr>
                    <th>#</th>
                    <th>Question Title Eng</th>
                    <th>Question Title Hin</th>
                    <th>Courses</th>
                    <th>A</th>
                    <th>B</th>
                    <th>C</th>
                ...
                <?php 
                  ...
                  if(!empty($qlisting)){
                    ...
                    <tr>
                        ...
                        <td><?=$list->q_title_en?></td>
                        <td><?=$list->q_title_hn?></td>
                        <td><?=$courses_name?></td>
                        <td><?=$list->opt1?></td>
                        <td><?=$list->opt2?></td>
                        <td><?=$list->opt3?></td>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('/admin/add_edit_question/'.$list->qno) ?>" class="btn btn-outline-info" role="button" title="View"><i class="fas fa-edit"></i></a>
                            <?php } ?>
                            
                            <?php if(is_privilege(26,5)){  ?>
                                <a href="<?= base_url('/admin/del_question/'.$list->qno) ?>" onclick="return confirm('Are you sure?')" class="btn btn-outline-info" role="button" style="color:red" title="Delete"><i class="fas fa-trash"></i></a>
                            <?php }  ?>
