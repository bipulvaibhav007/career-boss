        ...
        <form class="w-50 mx-auto" action="<?=current_url();?>" method="get">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="<?=base_url('/certificate-verification')?>" class="btn btn-warning">Reset</a>
                </div>
            </div>
        </form>
        ...
        <div class="my-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0 mx-2">Certificate Verification</h4>
                </div>
                <div class="card-body table-responsive">
                    <table class="table table-borderless mb-0">
                        ...
                        <tbody>
                            ...
                            <?php /*<tr>
                                <th scope="row" colspan="4">Marks Details</th>
                            </tr>
                            <tr>
                                <th scope="row">#</th>
                            ...
                            <?php if($results->module_marks != ''){
                                $marks = json_decode($results->module_marks);
                                if(!empty($marks)){
                                    $n = 1;
                                    foreach($marks as $m){ ?>
                                        <tr>
                                ...
                                <?php }
                                    echo '<tr>
                                        ...
                                        <th scope="row">'.$results->tot_fm.'</th>
                                        <th scope="row">'.$results->tot_mo.'</th>
                                    </tr>';
                                } 
                            } */ ?>
                            <?php }else{
